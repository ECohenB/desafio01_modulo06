<template>
  <div class="carnet">
    <aside>
      <div>
        <span class="cedula-titulo">CEDULA DE IDENTIDAD</span>
        <img width="40" src="/public/assets/chile_bandera.png" alt="Bandera de Chile" />
      </div>
      <img src="/public/assets/foto_elon.jpg" alt="Foto del titular" />
      <p>RUN {{ run }}</p>
    </aside>
